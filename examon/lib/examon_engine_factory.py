...
from examon.view.output.question import (
    MultiChoiceQuestionOutputter,
    InputParameterQuestionOutputter,
    FreeTextQuestionOutputter,
)
...
class ExamonEngineFactory:
    @staticmethod
    def build(
        questions, formatter_class, auto_answer=None, shuffle=False, mode=None
    ) -> ExamonEngine:
        ...
        view_mappings = {
            ...
            BaseQuestion.__name__: {
                ...
                "inputter": fetch_inputter(auto_answer, FreeTextAnswerInputter()),
            },
        }
        return ExamonEngine(
            questions=questions,
